...
def _handle_run(args):
    ...
    return lifecycle_handler.lifecycle_machine_run(
        args.context, args.machine, args.run_command,
...
def _handle_shell(args):
    ...
    return lifecycle_handler.lifecycle_machine_shell(
        args.context, args.machine, shell_path=args.shell,
...
def _handle_restart(args):
    ...
    with user_handler.user_try_lock(args.context):
        return lifecycle_handler.lifecycle_machine_restart(
            args.context, args.machine, force=args.force,
            namespace_name=namespace_name)
...
def _handle_stop(args):
    ...
    with user_handler.user_try_lock(args.context):
        return lifecycle_handler.lifecycle_machine_stop(
            args.context, args.machine, namespace_name=namespace_name)
...
def _handle_push(args):
    ...
    return lifecycle_handler.lifecycle_machine_push(
        args.context, args.machine, args.host_path, args.container_path, namespace_name=namespace_name)
...
def _handle_pull(args):
    ...
    return lifecycle_handler.lifecycle_machine_pull(
        args.context, args.machine, args.container_path, args.host_path, namespace_name=namespace_name)
...
def _handle_freeze(args):
    return dockerfile_packer.dockerfile_packer(args.context, args.machine)
